      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading font-extrabold text-2xl text-gray-900 tracking-tight flex items-center gap-2">
            ...
            Farm Yield & Earnings Reports
          </h2>
          <p className="text-xs text-gray-500 font-medium mt-0.5">
            Season financial analytics, channel profitability breakdown, and export statement.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-gray-500 uppercase">Season Net Revenue</span>
          ...
          <span className="text-[11px] text-emerald-600 font-bold flex items-center gap-1 mt-1">
            <TrendingUp className="w-3 h-3" /> +18.4% vs last season
          </span>
        </div>

        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-gray-500 uppercase">Total Harvest Volume</span>
          ...
          <span className="text-[11px] text-gray-500 font-medium mt-1 block">Across 4 registered lots</span>
        </div>

        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-gray-500 uppercase">Avg Profit Margin</span>
          ...
          <span className="text-[11px] text-gray-500 font-medium mt-1 block">AI optimized timing boost</span>
        </div>

        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-gray-500 uppercase">Active Crop Lots</span>
            <div className="w-8 h-8 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center">
              <PieChart className="w-4 h-4" />
            </div>
          </div>
          <div className="font-heading font-extrabold text-2xl text-gray-900 tracking-tight">
            {r.activeLotsCount} Lots
          </div>
          <span className="text-[11px] text-gray-500 font-medium mt-1 block">100% digital tracking</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <h3 className="font-heading font-bold text-base text-gray-900 mb-4">
            Monthly Farm Revenue Growth (2025)
          </h3>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
            ...
            {r.channelShare.map((c, idx) => (
              <div key={idx} className="flex items-center justify-between text-xs">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[10.5px] text-gray-400 font-medium">{c.percent}% Share</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-center">
            <span className="text-xs text-gray-500">
              Quick Commerce (Blinkit & Swiggy) generated <strong>60% of total revenue</strong>.
            </span>
          </div>
        </div>
