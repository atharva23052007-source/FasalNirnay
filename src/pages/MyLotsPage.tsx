        ...
        {farmerLots.map(lot => (
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  <span className="font-heading font-bold text-lg text-gray-900">{lot.cropName}</span>
                  <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800">
                    {lot.grade}
                  </span>
                </div>

                <span className="text-xs font-semibold text-gray-500">Variety: {lot.variety}</span>
                ...
                <div className="flex items-center gap-4 text-xs text-gray-600 mt-1">
                  ...
                  <span className="flex items-center gap-1">
                    <Calendar className="w-3.5 h-3.5 text-gray-400" /> {lot.harvestDate}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 grid grid-cols-2 gap-2 text-xs">
              <div>
                <span className="text-gray-400 text-[10.5px] font-bold uppercase block">Storage Status</span>
                <span className="font-bold text-gray-900 flex items-center gap-1 mt-0.5">
                  <Warehouse className="w-3.5 h-3.5 text-[#167A42]" /> {lot.storageStatus}
                </span>
              </div>
              <div>
                <span className="text-gray-400 text-[10.5px] font-bold uppercase block">Estimated Market Value</span>
